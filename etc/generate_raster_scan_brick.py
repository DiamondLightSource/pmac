...
def main():
    ...
    print('caput -a PMAC_TEST:GB1:A:Positions {0}'.format(no_of_rows * 62)),
    ...
    print('caput -a PMAC_TEST:GB1:B:Positions {0}'.format(no_of_rows * 62)),
    for index in range(no_of_rows):
      for pts in range(63):
    ...
    print('caput -a PMAC_TEST:GB1:ProfileTimeArray {0}'.format(no_of_rows * 62)),
    print('{0}'.format(3000)),
    for index in range(no_of_rows):
      for pts in range(62):
        print('{0}'.format(100)),
    ...
    print('caput -a PMAC_TEST:GB1:VelocityMode {0}'.format(no_of_rows * 62)),
    print('{0}'.format(2)),
    for index in range(no_of_rows):
      for pts in range(61):
        print('{0}'.format(0)),
    ...
    print('caput -c -w 1 PMAC_TEST:GB1:ProfileNumPoints {0}'.format(no_of_rows * 62))
